...
export default function Solution() {
  ...
  return (
    <section className="py-16 md:py-24 bg-zelly-bg-secondary">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div>
            <h3 className="text-3xl md:text-4xl font-bold text-zelly-text-primary mb-6">
              섞여 있어도 괜찮아요,<br />
              AI가 다 아니까
            </h3>
            <p className="text-lg text-zelly-text-secondary leading-relaxed">
