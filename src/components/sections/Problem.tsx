...
export default function Problem() {
  return (
    <>
      ...
      <section id="problem-overview" className="relative h-[100dvh] flex items-center snap-start bg-zelly-bg-primary pt-[60px] pb-2 md:pb-12 overflow-hidden">
      ...
      <section id="problem-section" className="relative h-[100dvh] bg-white snap-start flex items-center justify-center pt-[60px] pb-6 md:pb-12 overflow-hidden">
