...
export default function Emotional() {
  ...
  return (
    <section className="relative h-[100svh] flex flex-col items-center justify-center snap-start snap-always bg-zelly-bg-secondary md:pt-[60px] pt-4 pb-4 overflow-hidden">
